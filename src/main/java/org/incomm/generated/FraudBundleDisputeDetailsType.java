 ...
 *         &lt;element ref="{http://www.visa.com/ROLSI}VisaCaseNumber" maxOccurs="25" minOccurs="0"/&gt;
 *         &lt;element ref="{http://www.visa.com/ROLSI}DisputeId" maxOccurs="25" minOccurs="0"/&gt;
 *         &lt;element ref="{http://www.visa.com/ROLSI}RolTransactionId" maxOccurs="25" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class FraudBundleDisputeDetailsType {
    ...
    @XmlElement(name = "DisputeId", type = Long.class)
    protected List<Long> disputeId;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the disputeId property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getDisputeId().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Long> getDisputeId() {
        if (disputeId == null) {
            disputeId = new ArrayList<Long>();
        }
